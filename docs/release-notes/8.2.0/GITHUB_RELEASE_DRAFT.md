...
The big news in 8.2.0 is **CueSport Scoreboard Cloud**: optional hosted or self-hosted remote scoring, multi-table management, guest controls, match history, player statistics, and live-stream discovery for the OBS CueSport Scoreboard.
...
- **Mobile and guest scoring** — control matches from a phone or share a focused guest link/QR code
