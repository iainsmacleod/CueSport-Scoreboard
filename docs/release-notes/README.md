...
git add 8.3.0/images/
git commit -m "Update 8.3.0 release note screenshots"
```
...
```powershell
.\docs\release-notes\create-release.ps1 -Version 8.3.0
```
...
gh release create v8.3.0 \
  --draft \
  --title "CueSport Scoreboard 8.3.0" \
  --notes-file docs/release-notes/8.3.0/GITHUB_RELEASE_DRAFT.md
```
