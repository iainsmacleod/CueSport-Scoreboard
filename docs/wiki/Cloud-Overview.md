...
- **Impromptu tables** are dockless seats created from the Dashboard for scoring without OBS — league nights, side tables, and multi-table events you are not streaming (see [Multiple Tables](Multiple-Tables)).
