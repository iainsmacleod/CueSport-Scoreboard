...
- [Release notes](https://github.com/iainsmacleod/CueSport-Scoreboard/blob/main/docs/release-notes/8.3.5/RELEASE_NOTES.md) — 8.3.5 stats parity & polish (current build **8.3.5**)
